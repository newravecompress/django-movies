# Generated by Django 3.2 on 2021-06-10 19:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2001, verbose_name='Дата выхода')),
                ...
                ('fess_in_usa', models.PositiveIntegerField(default=0, help_text='сумма в долларах', verbose_name='Сборы в США')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='сумма в долларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=100, unique=True)),
